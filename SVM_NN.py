...
def image_feature_a(direc):
    ...
    img_name = [];
    for i in tqdm(direc):
        fnam = '/Users/macbook/Desktop/POLIMI/CORSI/II/I/CPC/Git/Save_The_World/SaveTheWorld/images/class_a' + '/' + i
...
def image_feature_b(direc):
    ...
    img_name = [];
    for i in tqdm(direc):
        fnam = '/Users/macbook/Desktop/POLIMI/CORSI/II/I/CPC/Git/Save_The_World/SaveTheWorld/images/class_b' + '/' + i
